...
>(({ className, showNotification, ...props }, ref) => (
  ...
  >
    {props.children}
    {showNotification && <span className="absolute top-1 right-1 h-2 w-2 rounded-full bg-primary" />}
  </TabsPrimitive.Trigger>
))
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-xl",
      className,
    )}
    {...props}
  />
