...
>(({ className, children, ...props }, ref) => {
  ...
  // Find if there's a DialogDescription among the children
  const hasDescription = React.Children.toArray(children).some(
    (child) => React.isValidElement(child) && child.type === DialogDescription,
  )

  // Set aria-describedby only if there's a description
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        {/* Clone children to pass descriptionId to DialogDescription */}
